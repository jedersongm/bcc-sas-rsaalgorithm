                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">		          	
                                ...
                                <div class="templatemo-input-icon-container">
                                    ...
                                    <input name="p" type = "text"  class="form-control" id="p" placeholder = "P -Informe um número primo" required>
                                </div>                                  
                            </div>
                        </div>                                
                        ...
                        <div class="form-group">
                            <div class="col-md-6">		          	
                                ...
                                <div class="templatemo-input-icon-container">
                                    <i class="fa fa-user"></i>
                                    <input name="q" type = "text"  class="form-control" id="apelido" placeholder = "Q -Informe um número primo" required>
                                </div>		            		            		            
                            </div> 
                        </div>
                        <div class="form-group">
